<?php
$utilisateurs = null; // Initialize the variable to null
try {
    $pdo = new PDO("mysql:host=localhost;dbname=bdpointage", "root", "");
    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

    // Fetch all users
    $stmt = $pdo->prepare("SELECT * FROM utilisateur ORDER BY nom_utilisateur ASC"); // Added ORDER BY
    $stmt->execute();
                ...
                <ul>
                    ...
                    <li>
                        <a href="index.php" class="active">
                            <span class="las la-users"></span> <small>Liste utilisateurs</small>
                        </a>
                    </li>
                </ul>
            </div>
    ...
    <div class="employee-list-container">
        <div class="employee-list-wrapper">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <a href="utilisateur.php" class="btn btn-success">
                ...
                <div class="input-group search-input-group">
                    <input type="text" class="form-control" placeholder="Rechercher un utilisateur..." aria-label="Rechercher un utilisateur" aria-describedby="button-addon2">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                        if ($utilisateurs != null && sizeof($utilisateurs) > 0):
                            $i = 0;
                            foreach ($utilisateurs as $utilisateur):
                                ...
                                <tr>
                                    ...
                                    <td><?= htmlspecialchars($utilisateur->mot_passe) ?></td>
                                    <td><?= htmlspecialchars($utilisateur->role) ?></td>
                                    <td class="options">
                                        <a href="modifier.php?id=<?= htmlspecialchars($utilisateur->id_utilisateur) ?>" class="btn btn-primary btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir modifier cet utilisateur ?')">
                                        ...
                                        <a href="delete.php?id=<?= htmlspecialchars($utilisateur->id_utilisateur) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet utilisateur ?')">
