...
<body>
            ...
            <div class="side-menu">
                <ul>
                    ...
                    <li>
                       <a href="index.php">
                            <span class=""></span>
                            <small>Liste horaires<h4></small></h4>
                        </a>
                    </li>
                    <li>
                       <a href="">
    ...
    <div class="content-wrapper">
        <div class="container mt-5 form-container">
            <center><h1>Ajouter un horaire</h1></center>
            <form action="insertion.php" method="post">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="time" name="heure_arrivee" class="form-control" step="0.01 "required>
                    </div>
                    <div class="form-group">
                        <label for="heure_depart">Heure de départ :</label>
                        <input type="time" name="heure_depart" class="form-control" step="0.01" required>
                    </div>
                </div>
