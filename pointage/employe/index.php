    ...
    <div class="employee-list-container">
        <div class="employee-list-wrapper">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <a href="employe.php" class="btn btn-success">
                ...
                <div class="input-group search-input-group">
                    <input type="text" class="form-control" placeholder="Rechercher un employé..." aria-label="Rechercher un employé" aria-describedby="button-addon2">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php
                    if ($employes != null && sizeof($employes) > 0):
                        $i = 0;
                        foreach ($employes as $employe):
                            ...
                            <tr>
                                ...
                                <td class="options">
                                    <a href="modifier.php?id=<?= $employe->id_employe ?>" class="btn btn-primary btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir modifier cet employé ?')">
                                    ...
                                    <a href="delete.php?id=<?= $employe->id_employe ?>" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette employé ?')">
