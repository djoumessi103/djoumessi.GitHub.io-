...
<a href="index.php">
 <span class=""></span>
 <small>Liste absences<h4></small></h4>
 </a>
 </li>
 <li>
<a href="">
 ...
 <small></small>
    ...
    <div class="content-wrapper">
        <div class="container mt-5 form-container">
            <center><h1>Ajouter une absence </h1></center>
            <form action="insertion.php" method="post">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="date" name="date_fin" class="form-control" step="0.01 "required>
                    </div>
                    <div class="form-group">
                        <label for="type_absence">Type absence :</label>
                        <input type="text" name="type_absence" class="form-control" step="0.01" required>
                    </div>
                </div>
