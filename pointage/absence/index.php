...
try {
    ...
    // Initial query to fetch all absences with employee names
    $stmt = $pdo->prepare("
        SELECT
            a.*,
...
<head>
    ...
    <style>
        ...
        * {
        ...
        .employee-list-container { /* Renamed for consistency, but applies to content area */
            flex-grow: 1;
            display: flex;
            justify-content: center;
        ...
        .employee-list-wrapper { /* Renamed for consistency, but applies to content wrapper */
            width: 100%;
            max-width: 1200px;
        }
        ...
        .employee-list-wrapper .btn-success {
            /* Keep existing styles if they are for the add button */
            margin-bottom: 1rem; /* Adjust if needed due to new layout */
            display: inline-block;
    ...
    <div class="employee-list-container">
        <div class="employee-list-wrapper">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <a href="absence.php" class="btn btn-success">
                ...
                <div class="input-group search-input-group">
                    <input type="text" class="form-control" placeholder="Rechercher une absence..." aria-label="Rechercher une absence" aria-describedby="button-addon2">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php
                    if ($absences != null && sizeof($absences) > 0):
                        $i = 0;
                        foreach ($absences as $absence):
                            ...
                            <tr>
                                <td><?= $i ?></td>
                                <td><?= $absence->employe_nom ?></td>
                                <td><?= $absence->date_debut ?></td>
                                <td><?= $absence->date_fin ?></td>
                                <td><?= $absence->type_absence ?></td>
                                <td class="options">
                                    <a href="modifier.php?id=<?= $absence->id_absence ?>" class="btn btn-primary btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir modifier cette absence ?')">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                                            <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325"/>
                                        </svg>
                                    </a>
                                    <a href="delete.php?id=<?= $absence->id_absence ?>" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette absence ?')">
